...
import 'package:neyimeshur/place/placeList_bloc.dart';
...
class PlaceCoveImage extends StatefulWidget {
  ...
  const PlaceCoveImage(
      {required this.isLoading, required this.placeDetails, super.key});

  @override
  State<PlaceCoveImage> createState() =>
      _PlaceCoveImageState(isLoading, placeDetails);
}
      ...
      return Container(
          ...
          decoration: BoxDecoration(
            image: DecorationImage(
                image: NetworkImage(placeDetails.photoRef), fit: BoxFit.cover),
          ),
          child: Column(
            children: [
              Row(
                    ...
                    child: SizedBox(
                      ...
                      child: FutureBuilder(
                        ...
                        builder: (BuildContext context,
                            AsyncSnapshot<dynamic> favSnapshot) {
