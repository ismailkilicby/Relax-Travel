...
import 'package:neyimeshur/ui/components/shimmerLoading.dart';
...
class _myFavoriteState extends State<myFavorite> {
  ...
  Future<void> navigateAndDisplaySelection(
      BuildContext context, placeType, placeId) async {
    if (placeType == 'locality') {
      isback = await Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) =>
                  locationDetails(placeId: placeId, searchType: 'city')));
    } else {
      isback = await Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) =>
                  locationDetails(placeId: placeId, searchType: 'attraction')));
    }
    //refresh ui when pop--------
    if (isback == true) {
      getFavorites();
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      navigateAndDisplaySelection(
                                          context,
                                          favListSnapshot[index].placeType,
                                                      ...
                                                      GestureDetector(
                                                        onTap: () {
                                                          ...
                                                          BlocProvider.of<
                                                                      placeListBloc>(
                                                                  context)
                                                              .add(placeRemoveFromFavorites(
                                                                  atPlaceId: favListSnapshot[
                                                                          index]
                                                                      .placeId));
                                                          setState(() {
