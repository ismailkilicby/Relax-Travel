...
class reviewList extends StatefulWidget {
  ...
  @override
  State<reviewList> createState() =>
      _reviewListState(currentReviews, mFPAddReview, reviewText, deleteReviews);
}
...
class _reviewListState extends State<reviewList> {
  ...
  _reviewListState(this.currentReviews, this.mFPAddReview, this.reviewText,
      this.deleteReviews);

  @override
  void initState() {
    UserService.onAuthStateChanged.listen((user) {
      setState(() {
        userId = user!.uid;
              ...
              children: [
                                                      ...
                                                      children: [
                                                        Row(
                                                          children: [
                                                            ...
                                                            Text(
                                                              TimeAgoSince.timeAgoSinceDate(isValidTimestamp(
                                                                      widget.currentReviews[
                                                                              index]
                                                                          [
                                                                          "publishAt"])
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      padding:
                          const EdgeInsets.only(top: 15, bottom: 5, left: 4),
                      child: Row(
                        children: [
                          Container(
                            width: 310,
