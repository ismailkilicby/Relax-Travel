...
import "package:neyimeshur/ui/fechLastViews.dart";
...
//set categorie list-----------------------------
  ...
  void getData() async {
    var apiUrl1 =
        'https://api.apify.com/v2/actor-tasks/detailed_camel~google-maps-scraper-task-1/runs?token=';
    final payload1 = {};
    ...
    if (lastViewsList.isEmpty && isBackButtonClick == false) {
      ...
      final decodedArraylastViewsList =
          jsonDecode(jsonStringlastViewsList!) as List<dynamic>;
      ...
      final decodedArrayhotelList =
          jsonDecode(jsonStringhotelList!) as List<dynamic>;
    ...
    attractionList = data
        .map((element) {
          ...
          if (attractionCity == currentCity) {
            if (element['imageUrls'] != null &&
                element['imageUrls'].isNotEmpty) {
              return {
                'name': element['title'],
                'id': element['placeId'],
      ...
      return ColorfulSafeArea(
        ...
        child: Center(
          ...
          children: [
            Padding(
              padding:
                  const EdgeInsets.only(left: 13.0, top: 30.0, bottom: 15.0),
              child: Row(
                children: [],
              ),
            ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 15.0, top: 0, bottom: 4),
                      child: Row(
                        children: [
                        ...
                        child: Card(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image:
                                      NetworkImage(lastViewsList[0]['image']),
                                  fit: BoxFit.fill,
                                ),
                              ),
                              child: Padding(
                                                        ...
                                                        Padding(
                                                          ...
                                                          child: SizedBox(
                                                            ...
                                                            child:
                                                              ...
                                                              onTap: () async =>
                                                                  {
                                                                if (isaddAttractionToFavorite[
                                                                        index] ==
                                                                    false)
                                                                  {
                                                                    setState(
                                                                        () {
                                                                      isaddAttractionToFavorite[
                                                                              index] =
                                                                          true;
                                                                    }),
                                                                    ...
                                                                    ScaffoldMessenger.of(
                                                                        ...
                                                                        .showSnackBar(const SnackBar(
                                                                            content:
                                                                                Text("Add place to the favorites"))),
                                                                  }
                                                                else
                                                                  {
                                                                    setState(
                                                                    ...
                                                                    ScaffoldMessenger.of(
                                                                        ...
                                                                        .showSnackBar(const SnackBar(
                                                                            content:
                                                                                Text("Removed place from the favorites"))),
                                                                  }
                                                              },
                                                              child: Card(
                                                                elevation: 0,
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Image.asset(
                                                                            isaddAttractionToFavorite[index]
