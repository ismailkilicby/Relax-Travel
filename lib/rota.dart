...
class Rotam extends StatefulWidget {
  const Rotam({super.key});
  @override
  State<Rotam> createState() => _mytripsState();
}

class _mytripsState extends State<Rotam> {
                                                                ...
                                                                child: Padding(
                                                                  padding:
                                                                      const EdgeInsets
                                                                          ...
                                                                          10.0),
                                                                  child: Text(
                                                                      '${onGoingTrips[index].places.length} days',
                                                                      style: GoogleFonts.cabin(
                                                                          // ignore: prefer_const_constructors
                                                                          textStyle: TextStyle(
                                                                        color: Color.fromARGB(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            image: NetworkImage(pastTrips[index]
                                                .tripCoverPhoto),
                                            fit: BoxFit.cover),
                                      ),
                                      child: Padding(
                                                        ...
                                                        child: Padding(
                                                          padding:
                                                              const EdgeInsets
                                                                  .all(10.0),
                                                          child: Text(
                                                              '${pastTrips[index].places.length} days',
                                                              style: GoogleFonts
                                                                  .cabin(
                                                                      // ignore: prefer_const_constructors
                                                                      textStyle:
