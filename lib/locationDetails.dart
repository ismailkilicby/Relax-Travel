...
import 'package:neyimeshur/placeCoverImage.dart';
import 'package:neyimeshur/placeDescreption.dart';
import 'package:neyimeshur/rotaolustur.dart';
import 'package:neyimeshur/rotaplani.dart';
import 'package:syncfusion_flutter_maps/maps.dart';
import 'package:neyimeshur/ui/components/shimmer.dart';
import 'package:uuid/uuid.dart';
import '../../place/placeList_bloc.dart';
import '../../place/place_event.dart';
import '../../place/place_state.dart';
import '../../class/rota_bloc.dart';
import '../../models/sehir_model.dart';
import '../../models/rota_model.dart';
import '../../timeAgoSinceDate.dart';
import '../ui/components/shimmerLoading.dart';
import '../ui/components/topButtonIndicator.dart';
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        ShimmerLoading(
                                          ...
                                          child: !isLoading
                                              ? FutureBuilder<List>(
                                                  future: searchType == 'city'
                                                      ? placeBloc.getWeather(
                                              ...
                                              if (snapshot.hasData) {
                                                return Padding(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      Text(
                                                        "From ${snapshot.data?[0]["currentCity"]}  ▪ ${snapshot.data?[0]["distance"]} km   ▪ ${snapshot.data?[0]["duration"]}",
                                                        style:
                                                            GoogleFonts.cabin(
                                                          textStyle:
                                                              const TextStyle(
